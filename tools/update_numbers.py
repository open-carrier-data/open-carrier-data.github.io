...
sub_once(r"python3 -m json.tool generated/devices/index.json \| grep -m1 -A \d+ '\"carrier_data_coverage_counts\"'", "python3 -c 'import json; print(json.load(open(\"generated/devices/index.json\"))[\"platforms\"][\"android\"][\"carrier_data_coverage_counts\"])'")
